...
import 'package:fitness_firestore/components/common/workout_level.dart';
...
class WorkoutDetails extends StatefulWidget {
  final String? id;
  const WorkoutDetails({Key? key, this.id}) : super(key: key);
...
class _WorkoutDetailsState extends State<WorkoutDetails> {
  ...
  bool _isAuthor() =>
      user != null && workout != null && user!.uid == workout!.author;
