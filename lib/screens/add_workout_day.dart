...
import 'package:fitness_firestore/components/drill/drill_remove_alert.dart';
import 'package:fitness_firestore/components/drill/drill.dart';
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: FormBuilder(
            key: _fbKey,
            autovalidateMode: AutovalidateMode.disabled,//!!!!!!!!!!  was autovalidate: false,
            initialValue: {},
            enabled:true,// was readOnly: false,
            child: Column(
